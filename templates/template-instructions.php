    ...
    <div class="container">
        ...
        <div>
            ...
            <div style="clear: both;">
                <p>&nbsp;</p>
                <h3 class="custom-h3">Step 1: Wrap you application using mg-tool API</h3>
            ...
            <div>
                <b>1 - Create a Tool.</b> <br>See the <a href="http://multiscale-genomics.readthedocs.io/en/latest/howto/howto_tool.html">HOWTO - Tools</a> for details about writing a tool and <a href="http://multiscale-genomics.readthedocs.io/en/latest/howto/howto_testing.html">
                ...
                <h3 class="custom-h3">Step 2: &nbsp;&nbsp; Register the tool into openVRE</h3>
                ...
                <ul class="custom-ul">
                    <li class="custom-li">1. Tool descriptions: titles, keywords, etc.</li>
                    <li class="custom-li">2. Input files and their requirements: accepted data types and formats, etc.</li>
                    <li class="custom-li">3. Tool arguments</li>
                ...
                <h3 class="custom-h3">Step 3: Test the tool virtual machine</h3>
                <p><a href="mailto:support.eucanshare@bsc.es">Contact us</a> and we’ll prepare and deploy a virtual machine for you in our testing cloud. As explained in detail at <a href="https://www.multiscalegenomics.eu/MuGVRE/integration-of-tools/tool-virtual-machine/">
