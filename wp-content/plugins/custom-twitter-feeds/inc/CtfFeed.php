...
class CtfFeed
{
    ...
    public function getFeedOpeningHtml()
    {
        ...
        $ctf_feed_html .= '<div class="swiper-container s-twitter"><div class="swiper-wrapper">';
    ...
    public function getFeedClosingHtml()
    {
        ...
        $ctf_feed_html .= '</div></div>'; // closing div for ctf-tweets
    ...
    public function getTweetSetHtml( $is_pagination = 0 )
    {
        ...
        if ( $is_pagination && ( ! isset ( $tweet_set[1]['id_str'] ) ) ) {
            ...
            while ( $i < $len ) {
                ...
                $tweet_classes = ' swiper-slide ctf-author-' . $author .' ctf-new';
